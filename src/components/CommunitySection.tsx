...
const POSTS: CommunityPost[] = [
  ...
  },
  {
    ...
    text: 'LFG my claim from @pokenic came it look how nice those slabs are\nthank you again one love',
    name: 'Mikerow',
