...
// Client half of /achievements — "Achievement System" matching live phygitals:
// centered hero with trophy + stat pills (count / total XP), 5 color-coded
// rarity-tier cards, then a sortable "All Achievements" data table. Standalone
// full-width route (global header/footer only — no account sidebar, matching live).
// Client component because the table is sortable; metadata lives in page.tsx.
//
