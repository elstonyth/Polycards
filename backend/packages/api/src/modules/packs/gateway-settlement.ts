// Settlement-report math for /admin/payments/settlement — the screen that
// answers "what did this week / this month actually do" from OUR database
// instead of the gateway's back office (money-path-accuracy-audit-2026-08-17
...
// column (the over-ceiling quarantine path in gateway-reconcile.ts ends in
