...
// The gateway_deposit.status domain — single source of truth for the model's
...
// GatewayDeposit — the outstanding-deposit record for the gateway.
//
...
export const GatewayDeposit = model
  .define('gateway_deposit', {
    ...
    // What the gateway actually keeps for us: amount_settled MINUS their fee, from
    ...
    // exists because without it the fee lives only in the gateway's back office,
    ...
    // the gateway's. These are what a bank quotes back in a dispute, and they were
